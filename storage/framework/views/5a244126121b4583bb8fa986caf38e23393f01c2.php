    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body text-center py-5">
                <div class="row g-4">
                    <div class="col-6">
                        <a href="<?php echo e(route('chat.index')); ?>" class="btn btn-outline-primary w-100 py-5 rounded-3 border-2">
...
</script><?php /**PATH G:\firstlaravel_demo\LegalEase\resources\views/components/chat-live.blade.php ENDPATH**/ ?>