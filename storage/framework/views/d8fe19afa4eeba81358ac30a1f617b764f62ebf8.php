        ...
        <div class="container-fluid px-3">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('announcements.index')); ?>">Announcements</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('faqs.index')); ?>">FAQ</a>
                    </li>
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('register.choice')); ?>">Register</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
...
<?php /**PATH G:\firstlaravel_demo\LegalEase\resources\views/layouts/guest.blade.php ENDPATH**/ ?>